...
class Borrow_Test(unittest.TestCase):
        ...
        if check_cta:
            ...
            if make_assert:
                self.assertTrue(conditions,
                                'Unable to find %s button on page.' % check_cta)
            if not conditions:
                return False
    ...
    def ol_verify_userid(self, olid, itemname):
        cta = self.ol_get_book_cta(olid, check_cta="read",
    ...
    def test_ia_borrow_ol_read_ol_return(self):
        ...
        self.ol_get_book_cta(OL_EDITION, check_cta="return",
                             make_assert=False, click=True)
        self.ia_get_book_cta(ocaid=IA_EDITION, check_cta="return",
                             make_assert=False, click=True)
        self.ia_get_book_cta(ocaid=IA_EDITION, check_cta="borrow",
                             make_assert=True, click=True)
    ...
    def test_ol_borrow_ia_read_ol_return(self):
        ...
        self.ol_get_book_cta(OL_EDITION, check_cta="return",
                             make_assert=False, click=True)
        self.ol_get_book_cta(OL_EDITION, check_cta="borrow",
                             make_assert=True, click=True)
        self.close_bookreader_switch_back_to_ol()
        self.ia_get_book_cta(IA_EDITION, check_cta="return",
                             make_assert=True, click=False)
        self.ol_verify_userid(OL_EDITION, LIVE_USER1['itemname'])
        self.ol_get_book_cta(OL_EDITION, check_cta="return",
                             make_assert=False, click=True)
    ...
    def test_waitinglist(self):
        ...
        self.ol_get_book_cta(OL_EDITION, check_cta="unwaitlist",
                             make_assert=False, click=True)
        olsession.logout(test=self)
        olsession.login(test=self, **LIVE_USER1)
        self.ol_get_book_cta(OL_EDITION, check_cta="return",
        ...
        olsession.logout(test=self)
        olsession.login(test=self, **LIVE_USER2)
        self.ol_get_book_cta(OL_EDITION, check_cta="waitlist",
                             make_assert=True, click=True)
